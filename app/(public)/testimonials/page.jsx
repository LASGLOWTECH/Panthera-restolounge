    ...
    <section className="py-24 px-6 md:px-16 bg-black text-[#bbbbbb] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold text-[#ffb703] mb-16 mt-16 text-center uppercase tracking-wider"
        >
          ...
          >
            {testimonials.map((item, i) => (
              <motion.div
                ...
                p-8 bg-dark border border-gold rounded-xl flex-shrink-0 
