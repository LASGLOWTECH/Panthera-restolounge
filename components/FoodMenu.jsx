    ...
    <div className="min-h-screen bg-dark text-white font-serif flex flex-col items-center relative overflow-hidden">
      ...
      <main className="max-w-7xl flex flex-col md:flex-row gap-16 px-6 py-8">
        ...
        >
          ...
          <p className="text-lg text-gray-300 mb-4">{currentImage.alt}</p>
          <p className="text-gray-400">
            Every plate is a crafted blend of Japanese precision and Peruvian
            boldness, prepared with meticulously selected ingredients and
            elevated through modern gourmet techniques.
          </p>
