...
export default function Navbar() {
 ...
 <div className="flex space-x-3">
              <a
                href="#"
                aria-label="TikTok"
                className="w-10 h-10 flex items-center justify-center bg-white/10  hover:bg-footer-accent transition duration-300 rounded-full text-white hover:text-dark"
              >
                <FaTiktok />
              </a>
              <a
